...
// Code style: jalankan `./gradlew spotlessApply` untuk merapikan & mengurutkan
// import (sekaligus membuang yang tak terpakai) + indentasi konsisten.
spotless {
    kotlin {
        target("src/**/*.kt")
        targetExclude("**/build/**")
        ktlint().editorConfigOverride(
            mapOf(
                // Nonaktifkan aturan yang tidak bisa auto-fix / tidak cocok dengan Compose & DTO API
